...
export class FormPageComponent implements OnInit {
  ...
  generateEmailBody(formData: any): string {
    ...
    if (
      formData.reporter.relationToInsured != null &&
      formData.reporter.relationToInsured !== ''
    ) {
      emailBody += `  Role in Relation to Loss: ${formData.reporter.relationToInsured}\n`;
    }
    if (formData.reporter.title != null && formData.reporter.title !== '') {
      emailBody += `  Title: ${formData.reporter.title}\n`;
    }
    if (
      formData.reporter.firstName != null &&
      formData.reporter.firstName !== ''
    ) {
      emailBody += `  First Name: ${formData.reporter.firstName}\n`;
    }
    if (
      formData.reporter.lastName != null &&
      formData.reporter.lastName !== ''
    ) {
      emailBody += `  Last Name: ${formData.reporter.lastName}\n`;
    }
    if (formData.reporter.phone != null && formData.reporter.phone !== '') {
      emailBody += `  Phone: ${formData.reporter.phone}\n`;
    }
    if (formData.reporter.email != null && formData.reporter.email !== '') {
      emailBody += `  Email: ${formData.reporter.email}\n`;
    }
    if (
      formData.reporter.addressOne != null &&
      formData.reporter.addressOne !== ''
    ) {
      emailBody += `  Address 1: ${formData.reporter.addressOne}\n`;
    }
    if (
      formData.reporter.addressTwo != null &&
      formData.reporter.addressTwo !== ''
    ) {
      emailBody += `  Address 2: ${formData.reporter.addressTwo}\n`;
    }
    if (formData.reporter.city != null && formData.reporter.city !== '') {
      emailBody += `  City: ${formData.reporter.city}\n`;
    }
    if (formData.reporter.state != null && formData.reporter.state !== '') {
      emailBody += `  State: ${formData.reporter.state}\n`;
    }
    if (formData.reporter.country != null && formData.reporter.country !== '') {
      emailBody += `  Country: ${formData.reporter.country}\n`;
    }
    if (
      formData.reporter.customCountry != null &&
      formData.reporter.customCountry !== ''
    ) {
      emailBody += `  Country Name: ${formData.reporter.customCountry}\n`;
    }
    if (
      formData.reporter.postalCode != null &&
      formData.reporter.postalCode !== ''
    ) {
    ...
    if (formData.policy.contactSameAsReporter) {
      ...
      if (formData.policy.title != null && formData.policy.title !== '') {
        emailBody += `  Title: ${formData.policy.title}\n`;
      }
      if (
        formData.policy.firstName != null &&
        formData.policy.firstName !== ''
      ) {
        emailBody += `  First Name: ${formData.policy.firstName}\n`;
      }
      if (formData.policy.lastName != null && formData.policy.lastName !== '') {
        emailBody += `  Last Name: ${formData.policy.lastName}\n`;
      }
      if (formData.policy.phone != null && formData.policy.phone !== '') {
        emailBody += `  Phone: ${formData.policy.phone}\n`;
      }
      if (formData.policy.email != null && formData.policy.email !== '') {
        emailBody += `  Email: ${formData.policy.email}\n`;
      }
      if (
        formData.policy.addressOne != null &&
        formData.policy.addressOne !== ''
      ) {
        emailBody += `  Address 1: ${formData.policy.addressOne}\n`;
      }
      if (
        formData.policy.addressTwo != null &&
        formData.policy.addressTwo !== ''
      ) {
        emailBody += `  Address 2: ${formData.policy.addressTwo}\n`;
      }
      if (formData.policy.city != null && formData.policy.city !== '') {
        emailBody += `  City: ${formData.policy.city}\n`;
      }
      if (formData.policy.state != null && formData.policy.state !== '') {
        emailBody += `  State: ${formData.policy.state}\n`;
      }
      if (formData.policy.country != null && formData.policy.country !== '') {
        emailBody += `  Country: ${formData.policy.country}\n`;
      }
      if (
        formData.policy.customCountry != null &&
        formData.policy.customCountry !== ''
      ) {
        emailBody += `  Country Name: ${formData.policy.customCountry}\n`;
      }
      if (
        formData.policy.postalCode != null &&
        formData.policy.postalCode !== ''
      ) {
    ...
    emailBody += `  Description: ${this.indentText(
      formData.loss.description,
      21
    )}\n`;
    if (formData.loss.lossLocation === 'SameAsReporter') {
      ...
      if (
        formData.loss.lossAddress.addressOne != null &&
        formData.loss.lossAddress.addressOne !== ''
      ) {
        emailBody += `  Address 1: ${formData.loss.lossAddress.addressOne}\n`;
      }
      if (
        formData.loss.lossAddress.addressTwo != null &&
        formData.loss.lossAddress.addressTwo !== ''
      ) {
        emailBody += `  Address 2: ${formData.loss.lossAddress.addressTwo}\n`;
      }
      if (
        formData.loss.lossAddress.city != null &&
        formData.loss.lossAddress.city !== ''
      ) {
        emailBody += `  City: ${formData.loss.lossAddress.city}\n`;
      }
      if (
        formData.loss.lossAddress.state != null &&
        formData.loss.lossAddress.state !== ''
      ) {
        emailBody += `  State: ${formData.loss.lossAddress.state}\n`;
      }
      if (
        formData.loss.lossAddress.country != null &&
        formData.loss.lossAddress.country !== ''
      ) {
        emailBody += `  Country: ${formData.loss.lossAddress.country}\n`;
      }
      if (
        formData.loss.lossAddress.customCountry != null &&
        formData.loss.lossAddress.customCountry !== ''
      ) {
        emailBody += `  Country Name: ${formData.loss.lossAddress.customCountry}\n`;
      }
      if (
        formData.loss.lossAddress.postalCode != null &&
        formData.loss.lossAddress.postalCode !== ''
      ) {
    ...
    if (formData.loss.areAuthoritiesNotified === 'Yes') {
      if (
        formData.loss.authorityType != null &&
        formData.loss.authorityType !== ''
      ) {
        emailBody += `    Type: ${formData.loss.authorityType}\n`;
      }
      if (
        formData.loss.authorityReportNumber != null &&
        formData.loss.authorityReportNumber !== ''
      ) {
        emailBody += `    Report Number: ${formData.loss.authorityReportNumber}\n`;
      }
      if (
        formData.loss.authorityAdditionalInformation != null &&
        formData.loss.authorityAdditionalInformation !== ''
      ) {
        emailBody += `    Description: ${this.indentText(
          formData.loss.authorityAdditionalInformation,
          22
    ...
    formData.loss.witnesses.forEach((witness: any, index: number) => {
      ...
      if (witness.title != null && witness.title !== '') {
        emailBody += `    Title: ${witness.title}\n`;
      }
      if (witness.firstName != null && witness.firstName !== '') {
        emailBody += `    First Name: ${witness.firstName}\n`;
      }
      if (witness.lastName != null && witness.lastName !== '') {
        emailBody += `    Last Name: ${witness.lastName}\n`;
      }
      if (witness.email != null && witness.email !== '') {
        emailBody += `    Email: ${witness.email}\n`;
      }
      if (witness.phone != null && witness.phone !== '') {
        emailBody += `    Phone: ${witness.phone}\n`;
      }
      if (witness.addressOne != null && witness.addressOne !== '') {
        emailBody += `    Address 1: ${witness.addressOne}\n`;
      }
      if (witness.addressTwo != null && witness.addressTwo !== '') {
        emailBody += `    Address 2: ${witness.addressTwo}\n`;
      }
      if (witness.city != null && witness.city !== '') {
        emailBody += `    City: ${witness.city}\n`;
      }
      if (witness.state != null && witness.state !== '') {
        emailBody += `    State: ${witness.state}\n`;
      }
      if (witness.country != null && witness.country !== '') {
        emailBody += `    Country: ${witness.country}\n`;
      }
      if (witness.customCountry != null && witness.customCountry !== '') {
        emailBody += `    Country Name: ${witness.customCountry}\n`;
      }
      if (witness.postalCode != null && witness.postalCode !== '') {
    ...
    formData.claimant.claimants.forEach((claimant: any, index: number) => {
      ...
      if (claimant.title != null && claimant.title !== '') {
        emailBody += `    Title: ${claimant.title}\n`;
      }
      if (claimant.firstName != null && claimant.firstName !== '') {
        emailBody += `    First Name: ${claimant.firstName}\n`;
      }
      if (claimant.lastName != null && claimant.lastName !== '') {
        emailBody += `    Last Name: ${claimant.lastName}\n`;
      }
      if (claimant.email != null && claimant.email !== '') {
        emailBody += `    Email: ${claimant.email}\n`;
      }
      if (claimant.phone != null && claimant.phone !== '') {
        emailBody += `    Phone: ${claimant.phone}\n`;
      }
      if (claimant.addressOne != null && claimant.addressOne !== '') {
        emailBody += `    Address 1: ${claimant.addressOne}\n`;
      }
      if (claimant.addressTwo != null && claimant.addressTwo !== '') {
        emailBody += `    Address 2: ${claimant.addressTwo}\n`;
      }
      if (claimant.city != null && claimant.city !== '') {
        emailBody += `    City: ${claimant.city}\n`;
      }
      if (claimant.state != null && claimant.state !== '') {
        emailBody += `    State: ${claimant.state}\n`;
      }
      if (claimant.country != null && claimant.country !== '') {
        emailBody += `    Country: ${claimant.country}\n`;
      }
      if (claimant.customCountry !== null && claimant.customCountry !== '') {
        emailBody += `    Country Name: ${claimant.customCountry}\n`;
      }
      if (claimant.postalCode != null && claimant.postalCode !== '') {
  ...
  async constructEmailLink(emailBody: string): Promise<string> {
    ...
    const subject = encodeURIComponent(
      this.formatDateUS(new Date()) +
        '_FNOL Portal Request - Reference: ' +
        this.sessionKey
    );
    ...
    if ((baseMailto + encodedEmailBody).length > 2000) {
      ...
      encodedEmailBody = encodeURIComponent(
